...
class SettingsViewController: UIViewController, UITableViewDelegate, UITableViewDataSource, XGPSDelegate, SettingDetailDelegate {
    ...
    override func viewWillAppear(_: Bool) {
        ...
        NotificationCenter.default.addObserver(self, selector: #selector(setAvailabilityOfUI), name: NSNotification.Name(rawValue: "updateSettings"), object: nil)
...
//        cell.detailTextLabel?.text = itemValues[key]
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        if cell?.accessoryType == UITableViewCell.AccessoryType.disclosureIndicator {
            let vc = storyboard?.instantiateViewController(withIdentifier: "SettingDetail") as! SettingDetailViewController
